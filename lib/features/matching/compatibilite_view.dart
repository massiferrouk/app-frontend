...
/// Vue calendrier annuel (variante A, expérimentation APP-100) :
/// un rang par mois, une case colorée par semaine. Toute l'alternance
/// visible d'un coup — le détail est au tap, comme la vue liste.
...
/// Vue blocs mensuels (variante B, expérimentation APP-100) :
/// une carte par mois, 2 par ligne, une bande colorée par semaine.
/// Chaque carte affiche le décompte du mois (« 3 éch · 1 coloc »).
